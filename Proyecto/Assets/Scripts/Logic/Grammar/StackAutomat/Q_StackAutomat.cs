...
using UnityEngine;
/// <summary>Stack automat for Q grammar</summary>
public class Q_StackAutomat
{
    ...
    /// <summary>Initializes a new instance of the <see cref="Q_StackAutomat" /> class.</summary>
    /// <param name="grammar">The grammar.</param>
    public Q_StackAutomat ( GenericGrammar grammar )
    {
    ...
    public bool CheckProductionOf ( char x )
    {
        ...
        {
            if(!CheckSelectionSetOfPeek ( productions , x ) ){
                return false;
            }
