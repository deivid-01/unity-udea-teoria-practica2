...
/// <summary>
/// UnitTest for LL grammar operations
/// </summary>
public class LLTest 
{
    [Test]
    public void BelongTest () {
        ...
        */
        ...
        production1.leftSide = new Element ( Element.Kind.noTerminal , 'B' ,1);
        production2.leftSide = new Element ( Element.Kind.noTerminal , 'B' ,2);
        production3.leftSide = new Element ( Element.Kind.noTerminal , 'C' ,3);
        production4.leftSide = new Element ( Element.Kind.noTerminal , 'C' ,4);
        ...
        */
        ...
        var result=LL.Belong(genericGrammar);
    ...
    public void ValidateRowTest () {
        ...
        #endregion
        LL grammarLL = new LL(genericGrammar);
        string row="baacc¬";
         
         var result=grammarLL.ValidateRow(row);
