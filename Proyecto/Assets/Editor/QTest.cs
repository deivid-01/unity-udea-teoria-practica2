...
public class QTest 
{
    ...
    public void BelongTest () {
        ...
        */
        ...
        var result= Q.Belong ( genericGrammar );

        Assert.That ( result , Is.EqualTo ( true ) );


    }
    public void IsDisjointSelectionSetTest ()
    {
        ...
        var result= Q.IsDisjointSelectionSet ( genericGrammar );
    ...
    public void ValidateRowTest () {
        ...
        Q grammarQ=new Q(genericGrammar);

        string row="abaacc¬";

        var result=  grammarQ.ValidateRow ( row );
